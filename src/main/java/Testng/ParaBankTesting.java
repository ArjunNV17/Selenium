...
//		driver.findElement(By.id("FirstName")).sendKeys("Prabal");//approch no.1, it given instance result
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.name("customer.address.street"))).sendKeys("Kannapuran");
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.name("customer.username"))).sendKeys("Arjun10");
	...
	public void Login(){
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.name("username"))).sendKeys("Arjun10");
